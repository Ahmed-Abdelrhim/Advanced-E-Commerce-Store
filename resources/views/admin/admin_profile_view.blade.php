...
{{--                        <img class="rounded-circle" src="{{auth()->user()->getFirstMediaUrl('avatars','profile image')}}" alt="User Avatar">--}}
                        <img class="rounded-circle" src="{{auth()->user()->images}}" alt="User Avatar">
